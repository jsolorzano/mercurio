...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="row">
        <div class="col-lg-12">
            <a href="<?php echo base_url() ?>modulos/register">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($listar as $modulo) { ?>
                            <tr style="text-align: center">
                                ...
                                <td>
                                    <?php echo $modulo->class; ?>
                                </td>
                                <td>
                                    <?php echo $modulo->route; ?>
                                </td>
                                <td style='text-align: center'>
                                    <a href="<?php echo base_url() ?>modulos/edit/<?= $modulo->id; ?>" title="Editar" style='color: #1ab394'><i class="fa fa-edit fa-2x"></i></a>
                                </td>
                                <td style='text-align: center'>
                                    
                                    <a class='borrar' id='<?php echo $modulo->id; ?>' style='color: #1ab394' title='Eliminar'><i class="fa fa-trash-o fa-2x"></i></a>
                                </td>
                            </tr>
                            <?php $i++ ?>
                        <?php } ?>
        ...
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              ...
              $.post('<?php echo base_url(); ?>modulos/delete/' + id + '', function (response) {
